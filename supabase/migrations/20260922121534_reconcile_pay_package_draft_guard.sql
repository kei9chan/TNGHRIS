-- Drafts must remain editable through the guarded SECURITY DEFINER entrypoints.
-- Approved and completed history remains immutable.
...
begin
 ...
 if new.source_kind='approved_pan' and
    (new.source_pan_id is null or new.status<>'approved' or new.approval_state<>'approved') then
