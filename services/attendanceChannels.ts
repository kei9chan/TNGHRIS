...
export type ClockEvidence={method:'web'|'gps'|'qr'|'ob';obId?:string;capturedAt?:string;selfiePath?:string;siteId?:string;latitude?:number;longitude?:number;accuracy?:number;token?:string};
