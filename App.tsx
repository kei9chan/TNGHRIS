...
const ServiceChargeSetupPage = React.lazy(() => import('./modules/payroll/ServiceChargeSetupPage'));
...
const AttendancePulsePage = React.lazy(() => import('./pages/payroll/AttendancePulse'));
    ...
    <React.Suspense fallback={<div className="flex items-center justify-center h-screen"><div className="animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-blue-500"></div></div>}>
      ...
      >
        ...
        <Route path="payroll" element={<Outlet />}>
            ...
            <Route path="attendance-pulse" element={<ProtectedRoute><AttendancePulsePage /></ProtectedRoute>} />
            ...
            <Route path="pilot" element={<ProtectedRoute><PayrollPilotPage /></ProtectedRoute>} />
            ...
            <Route path="special-pay" element={<ProtectedRoute><SpecialPayPage /></ProtectedRoute>} />
