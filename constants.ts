...
export const NAV_LINKS: NavLink[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { name: 'Compare & Pilot', path: '/payroll/pilot', requiredPermission: { resource: 'Dashboard', permission: Permission.View } },
            ...
            { name: 'Historical Payroll Reconciliation', path: '/payroll/historical-reconciliation', requiredPermission: { resource: 'Dashboard', permission: Permission.View }, visibilityRoles: [Role.Admin, Role.BOD, Role.HRManager, Role.HRStaff] },
            ...
            { name: 'Loans & Debt', path: '/payroll/loans', requiredPermission: { resource: 'Loans', permission: Permission.View } },
        ...
        children: [
            ...
            { 
                ...
                children: [
                    ...
                    { name: 'Saved Job Posts', path: '/recruitment/saved-job-posts', requiredPermission: { resource: 'JobPosts', permission: Permission.Manage } },
            ...
            { name: 'Interview Templates', path: '/recruitment/interview-templates', requiredPermission: { resource: 'Interviews', permission: Permission.Manage } },
