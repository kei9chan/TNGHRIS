...
export const isPayrollAccessRoute = (path: string) => ['/payroll/run','/payroll/import-attendance','/payroll/historical-reconciliation','/payroll/historical-attendance', '/payroll/historical-corrections', '/payroll/home', '/payroll/access', '/payroll/pay-packages', '/payroll/attendance-readiness', '/payroll/gross-pay', '/payroll/net-pay'].includes(path);
