...
export const isPayrollAccessRoute = (path: string) => ['/payroll/home', '/payroll/access', '/payroll/pay-packages', '/payroll/attendance-readiness', '/payroll/gross-pay', '/payroll/net-pay'].includes(path);
