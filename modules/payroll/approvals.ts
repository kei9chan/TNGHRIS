...
export type Payslip={id:string;employeeName:string;from:string;to:string;payDate:string;gross:string;deductions:string;net:string;tax:string;contact:string;releasedAt:string;lines:{label:string;amount:string}[];contributions:{label:string;amount:string}[];loans:{account:string;amount:string}[];otherDeductions:{label:string;amount:string}[]};
