...
export type PayLine={deferred?:string;projectedBalance?:string;kind?:string;category?:string;settled?:string;label?:string;amount?:string;remaining?:string;date?:string;quantity?:string;rate?:string;factor?:string;start?:string;end?:string;account?:string;sourceRef?:string;monthly?:string;prior?:string};
