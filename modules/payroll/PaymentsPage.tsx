 ...
 return <div className="space-y-6">
  ...
  {w&&<>
   ...
   <Card title="Payment evidence and reissue history">
    ...
    {w.batch&&!w.batch.closed&&w.canRecordOutcome&&<form className="mt-4 space-y-3" onSubmit={e=>{e.preventDefault();if(attempt)void perform(()=>recordPaymentOutcome(attempt.id,attempt.lastEvent,status,outcomeDate,outcomeRef,reason,requestId),'Actual outcome recorded.');}}>
