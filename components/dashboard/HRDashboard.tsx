    ...
    const actionItems = useMemo(() => {
        ...
        const getNotificationDetails = (notification: Notification) => {
            switch(notification.type) {
                ...
                case NotificationType.MANPOWER_REQUEST_SUBMITTED:
                    return {
