...
const PANModal: React.FC<PANModalProps> = (props) => {
  ...
  return <Modal isOpen={isOpen} onClose={saving ? () => {} : onClose} title={pan ? `${canEdit ? 'Edit' : 'PAN Details'} — ${pan.employeeName}` : 'Create New PAN'} size="full" viewportFit footer={
    <div>
