...
const getStatusChip = (type: EmployeeDocument['type'], status: string) => {
    ...
    if (type === 'Personnel Action Notice') {
        ...
        switch(status) {
            ...
            case COERequestStatus.PendingHRManagerApproval: colorClass = 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300'; break;
            case COERequestStatus.ReturnedForRevision: colorClass = 'bg-orange-100 text-orange-800 dark:bg-orange-900/50 dark:text-orange-300'; break;
        }
