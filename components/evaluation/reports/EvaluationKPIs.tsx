...
const TrophyIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M12 6a9 9 0 11-9 9 4.5 4.5 0 019 0 4.5 4.5 0 019 0 9 9 0 01-9 9z" /></svg>;
...
const EvaluationKPIs: React.FC<EvaluationKPIsProps> = ({ data }) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard title="Overall Avg. Score" value={data.overallScore.toFixed(2)} icon={<ChartBarIcon />} colorClass="bg-blue-500" />
            <StatCard title="Completion Rate" value={`${data.completionRate.toFixed(0)}%`} icon={<ClipboardCheckIcon />} colorClass="bg-green-500" />
            <StatCard title="Participants" value={data.participants} icon={<UserGroupIcon />} colorClass="bg-purple-500" />
            <StatCard title="Top Department" value={data.topDepartment} icon={<TrophyIcon />} colorClass="bg-yellow-500" />
        </div>
    );
};
