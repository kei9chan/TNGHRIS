                ...
                {requestToEdit && (
                    <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-600 dark:bg-slate-800">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div><p className="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Employee</p><p className="mt-1 font-semibold text-slate-900 dark:text-white">{request.employeeName || '—'}</p></div>
                            <div><p className="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Position</p><p className="mt-1 font-semibold text-slate-900 dark:text-white">{request.employeePosition || 'Position not recorded'}</p></div>
