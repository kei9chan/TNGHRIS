...
assert.match(generator, /fitTitleToBox/);
assert.match(generator, /minimumFontSize = 32/);
assert.match(generator, /maxLines = 4/);
assert.match(generator, /const pieces: string\[\] = \[\]/);
assert.match(generator, /partIndex === 0 && current/);
