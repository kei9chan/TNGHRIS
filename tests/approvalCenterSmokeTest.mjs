...
const checks = [
  ...
  [widget.includes("name:'NTE'") && widget.includes("name:'PAN'") && widget.includes("name:'Offer Approvals'") && widget.includes("name:'Job Requisitions'"), 'dashboard consolidated queue counts'],
  [widget.includes('additional.pendingOfferApprovals.length') && widget.includes("slug:'offer'"), 'offer approval assignments appear in dashboard queue'],
