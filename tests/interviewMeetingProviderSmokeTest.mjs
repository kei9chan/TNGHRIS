...
assert.match(scheduler, /Create a Google Meet link automatically/);
assert.match(scheduler, /Paste an existing Zoom, Teams, Meet, Webex, or other link/);
assert.match(scheduler, /Open\/Test Link/);
assert.match(scheduler, /Clear Link/);
